...
class TranslateNewCategories implements \Magento\Framework\Event\ObserverInterface
{
    protected $logger;
    ...
    {
        $useAutomation = $this->scopeConfig->getValue('globallink_translate_new_entities/translate_new_categories/translate_new_categories', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $category = $observer->getEvent()->getCategory();
        if ($category->isObjectNew() && $useAutomation) {
            ...
            $queueData = [
                ...
                'entity_type_id' => $this->helper::CATALOG_CATEGORY_TYPE_ID,
            ...
            if(empty($targetLocales)){
                ...
                try {
                    ...
                    if ($this->submitTranslations->isJobLocked() && $this->isAutomaticMode) {
                        ...
                        $this->messageManager->addSuccessMessage(__('Category has been sent for translation.'));
                    } else{

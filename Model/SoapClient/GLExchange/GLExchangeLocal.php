...
class GLExchangeLocal extends GLExchange
{
    ...
    public function __construct(
        ...
        if(substr($version, 0, 6) === '2.4.11' || substr($version, 0, 6) === '2.4.10' || substr($version, 0, 5) === '2.4.9' || substr($version, 0, 5) === '2.4.8' || substr($version, 0, 5) === '2.4.7' || substr($version, 0, 5) === '2.4.4' || substr($version, 0, 5) === '2.4.5' || substr($version, 0, 5) === '2.4.6' || substr($version, 0, 3) === '2.5') {
